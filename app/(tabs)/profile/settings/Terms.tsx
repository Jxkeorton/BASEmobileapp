...
const TermsAndConditionsScreen = () => {
  return (
    <ScrollView style={styles.container}>
      ...
      <Text>
        - <Text style={styles.strongText}>Application</Text> means the software
        program provided by the Company downloaded by You on any electronic
        device, named BASE map
      </Text>
      <Text>
        - <Text style={styles.strongText}>Application Store</Text> means the
        digital distribution service operated and developed by Apple Inc. (Apple
        App Store) or Google Inc. (Google Play Store) in which the Application
        has been downloaded.
      </Text>
      <Text>
      ...
      <Text>
        - <Text style={styles.strongText}>Country</Text> refers to: United
        Kingdom
      </Text>
      <Text>
      ...
      <Text>
        - <Text style={styles.strongText}>Feedback</Text> means feedback,
      ...
      <Text>
        - <Text style={styles.strongText}>Subscriptions</Text> refer to the
        services or access to the Service offered on a subscription basis by the
        Company to You.
      </Text>
      <Text>
      ...
      <Text>
        -{" "}
        <Text style={styles.strongText}>Third-party Social Media Service</Text>{" "}
